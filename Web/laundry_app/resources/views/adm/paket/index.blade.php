...
{{-- <script rel="javascript" type="text/javascript" src="http://code.jquery.com/jquery-1.11.1.min.js"></script> --}}
    ...
    {{-- <script type="text/javascript">
        ...
        function read() {
            $.get("{{ url('admin/paket/read') }}", {}, function(data, status) {
                $("#read").html(data);
            });
        }
    
        function create() {
            $.get("{{ url('admin/paket/create') }}", {}, function(data, status) {
        ...
        function edit(id) {
            $.get("{{ url('admin/paket/edit') }}/" + id, {}, function(data, status) {
