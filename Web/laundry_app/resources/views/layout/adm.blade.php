        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="compactSidebar">
                ...
                <ul class="menu-categories">
                    <li class="menu {{ Request::is('dashboard') ? 'active' : '' }}">
                        <a href="#dashboard" name="dashboard" data-active="{{ Request::is('dashboard') ? 'true' : '' }}"
                            class="menu-toggle">
                            <div class="base-menu">
            ...
            <div id="compact_submenuSidebar" class="submenu-sidebar">
                ...
                <div class="theme-brand-name">
                    <a href="/admin">Laundry</a>
                </div>

                <div class="submenu" id="dashboard" name="dashboard">
                    ...
                    <ul class="submenu-list" data-parent-element="#dashboard">
                        <li>
                            <a href="/admin/dashboard"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                ...
                <div class="submenu" id="app">
                    <div class="category-info">
                        <h5>Data Master</h5>
                        <p>This menu contains master data information.</p>
                    </div>
                    <ul class="submenu-list" data-parent-element="#app">
                        <li>
                            <a href="/admin/outlet"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li>
                            <a href="/admin/paket"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-circle">
                                        <circle cx="12" cy="12" r="10"></circle>
                        ...
                        <li>
                            <a href="/admin/user"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-circle">
                                        <circle cx="12" cy="12" r="10"></circle>
                ...
                <div class="submenu" id="users">
                    ...
                    <ul class="submenu-list" data-parent-element="#users">
                        <li>
                            <a href="/admin/member"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-circle">
                                        <circle cx="12" cy="12" r="10"></circle>
                ...
                <div class="submenu" id="data">
                    ...
                    <ul class="submenu-list" data-parent-element="#data">
                        <li class="active">
                            <a href="/admin/transaksi"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-circle">
                                        <circle cx="12" cy="12" r="10"></circle>
                ...
                <div class="submenu" id="report">
                    ...
                    <ul class="submenu-list" data-parent-element="#report">
                        <li class="active">
                            <a href="/admin/detail"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-circle">
                                        <circle cx="12" cy="12" r="10"></circle>
                        ...
                        <li class="active">
                            <a href="/admin/detail/invoice"><span class="icon"><svg
