                ...
                <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
                    ...
                    <div class="dropdown-item">
                        <form action="/logout" method="post">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg> <span>Log Out</span></a>
                            </button>
                        </form>
                    </div>
                </div>
        ...
        <div id="compact_submenuSidebar" class="submenu-sidebar">
            ...
            <div class="submenu" id="dashboard">
                ...
                <ul class="submenu-list" data-parent-element="#dashboard">
                    <li>
                        <a href="/owner/dashboard"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            ...
            <div class="submenu" id="app">
                ...
                <ul class="submenu-list" data-parent-element="#app">
                    <li>
                        <a href="/owner/user"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            {{-- <div class="submenu" id="users">
                ...
                <ul class="submenu-list" data-parent-element="#users">
                    <li>
                        <a href="/kasir/pelanggan"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="feather feather-circle">
                                    <circle cx="12" cy="12" r="10"></circle>
            ...
            {{-- <div class="submenu" id="data">
                ...
                <ul class="submenu-list" data-parent-element="#data">
                    <li class="active">
                        <a href="starter_kit_blank_page.html"><span class="icon"><svg
            ...
            <div class="submenu" id="report">
                ...
                <ul class="submenu-list" data-parent-element="#report">
                    <li class="active">
                        <a href="/owner/detail"><span class="icon"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="feather feather-circle">
                    ...
                    <li class="active">
                        <a href="/owner/detail/invoice"><span class="icon"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="feather feather-circle">
