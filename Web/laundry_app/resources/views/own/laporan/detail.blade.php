                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-12">
                            ...
                            <ul class="nav nav-pills inv-list-container d-block" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <div class="nav-link list-actions" id="{{ $detail->transaksi->kode_invoice }}" data-invoice-id="{{ $detail->transaksi->kode_invoice }}">
                                        <div class="f-m-body">
                                            <div class="f-head">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dollar-sign"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
                                            </div>
                                            <div class="f-body">
                                                <p class="invoice-number">Invoice {{ $detail->transaksi->kode_invoice }}</p>
                                                <p class="invoice-customer-name"><span>To:</span> {{ $detail->member->name }}</p>
                                                <p class="invoice-generated-date">Date: {{ $detail->transaksi->tgl }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <div class="content-section  animated animatedFadeInUp fadeInUp">
                                    ...
                                    <div class="row inv--head-section">
                                        ...
                                        <div class="col-sm-6 col-12 align-self-center text-sm-right">
                                            <div class="company-info">
                                                <img src="/assets/img/logo.png" alt="" srcset="" width="10%" class="mr-2">
                                    ...
                                    <div class="row inv--detail-section">
                                        ...
                                        <div class="col-sm-5 align-self-center  text-sm-right order-sm-0 order-1">
                                            <p class="inv-detail-title">From : {{ $detail->outlet->name }}</p>
                                        </div>
                                        
                                        <div class="col-sm-7 align-self-center">
                                            <p class="inv-customer-name">{{ $detail->member->name }}</p>
                                            <p class="inv-street-addr">{{ $detail->member->alamat }},
                                                {{ $detail->member->village->name }}, <br>
                                                {{ $detail->member->district->name }},
                                                {{ $detail->member->regency->name }},
                                                {{ $detail->member->province->name }}</p>
                                        </div>
                                        <div class="col-sm-5 align-self-center  text-sm-right order-2">
                                            <p class="inv-list-number"><span class="inv-title">Invoice Number : </span> <span class="inv-number">[invoice number]</span></p>
                                            <p class="inv-created-date"><span class="inv-title">Invoice Date : </span> <span class="inv-date">{{ $detail->transaksi->tgl }}</span></p>
                                            <p class="inv-due-date"><span class="inv-title">Due Date : </span> <span class="inv-date">{{ $detail->transaksi->batas_waktu }}</span></p>
                                        </div>
                                    </div>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-right">{{ $detail->transaksi->diskon }}</td>
                                                            <td class="text-right">{{ $detail->transaksi->pajak }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
