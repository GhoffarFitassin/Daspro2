                ...
                <div class="alert alert-danger mb-4" role="alert"> 
                    <button type="button" class="close" data-dismiss="alert"
                        aria-label="Close"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <line x1="18" y1="6" x2="6" y2="18"></line>
                            <line x1="6" y1="6" x2="18" y2="18"></line>
                        </svg></button> <strong>Failed!</strong> {{ session('fail') }}
                    </div>
            @endif
            <div class="widget-content widget-content-area br-6">
                <div class="row">
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 mt-3 mb-0" style="margin-left: 15px">
                        ...
                        <a href="/admin/transaksi/create" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg> Add Data</a>
                    </div>
                </div>
                <div id="read" class="table-responsive mb-4 mt-1">
                    @include('adm.transaksi.read')
                </div>
            </div>
        </div>
    </div>
...
{{-- <script rel="javascript" type="text/javascript" src="http://code.jquery.com/jquery-1.11.1.min.js"></script> --}}
    ...
    {{-- <script type="text/javascript">
        ...
        function read() {
            $.get("{{ url('admin/pelanggan/read') }}", {}, function(data, status) {
                $("#read").html(data);
            });
        }
    
        function create() {
            $.get("{{ url('admin/pelanggan/create') }}", {}, function(data, status) {
        ...
        function edit(id) {
            $.get("{{ url('admin/pelanggan/edit') }}/" + id, {}, function(data, status) {
        ...
        function update(id) {
            ...
            $.ajax({
                type: "get",
                url: "{{ url('admin/pelanggan/update') }}/" + id,
                data: data,
                // data: "merek=" + merek,
                success: function(data) {
        ...
        function destroy(id) {
            if (confirm("Apakah Anda Yakin?")) {
                ...
                'nama_pelanggan': $("#name").val(),
                'jenis': $("#type").val(),
                'harga': $("#price").val(),
            }
            $.ajax({
                type: "get",
                url: "{{ url('admin/pelanggan/destroy') }}/" + id,
                data: data,
                // data: "merek=" + merek,
                success: function(data) {
